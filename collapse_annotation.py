...
if __name__ == '__main__':
    ...
    parser.add_argument('--transcript_gtf', help='Transcript annotation in GTF format', default="gencode.v29.annotation.gtf.gz")
    parser.add_argument('--output_gtf', help='Name of the output file', default="collapsed.gencode.v29.gtf")
